...
// Darknet
//---------------------------------------------------------------------------
Darknet::Darknet(const char *cfg_file, torch::Device *device, int _num_classes)
{
...
void Darknet::load_weights(const char *weight_file)
{
	...
	/*at::TensorOptions options= torch::TensorOptions()
		...
		.is_variable(true);*/
	//@ihmc3jn09hk Remove unused code
...
torch::Tensor Darknet::write_results(torch::Tensor prediction, float confidence, float nms_conf)
{
