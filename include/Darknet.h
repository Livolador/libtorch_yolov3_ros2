...
public:
	Darknet(const char *conf_file, torch::Device *device, int _num_classes);
	...
	torch::Tensor write_results(torch::Tensor prediction, float confidence, float nms_conf = 0.4);
